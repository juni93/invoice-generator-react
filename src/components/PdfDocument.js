		...
		<Document>
			<Page style={styles.body}>
				...
				<View style={styles.flexSpace}>
					<View>
						<Text style={{ fontSize: 12 }}>Facture n° {fac}</Text>
					...
					<View style={styles.tableRow}>
						<View
							style={
								withDetails
									? styles.tableColDesc
									: styles.tableColDescWithoutDetails
							}
						>
				...
				<View style={styles.flexSpace}>
					...
					{avecTva ?
						<View>
							...
							<View style={styles.flexSpace}>
								<Text style={styles.totalTitles}>
									Total T.V.A:{" "}
								</Text>
								<Text style={styles.totalValues}>
									{" "}
									{currencyFormatter(totalTax())}{" "}
								</Text>
							</View>
							<View style={styles.flexSpace}>
						...
						<View>
							...
							<View  style={styles.flexSpace}>
								<Text style={styles.totalTitles}>TVA Autoliquidation</Text>
							</View>
						</View>
					}
			</View>
			<View style={styles.notes}>
				<Text>
					VALEUR EN VOTRE AIMABLE REGLEMENT AU JOUR DE RECEPTION
					FACTURE REGLEMENT PAR VIREMENT BANCAIRE
				</Text>
			</View>
			<View style={styles.footerNotes}>
				<Text>
					{supplierData ? supplierData.footer.firstLine : ""}
				</Text>
				<Text>
					{supplierData ? supplierData.footer.secondLine : ""}
				</Text>
				<Text>
					{supplierData ? supplierData.footer.thirdLine : ""}
				</Text>
			</View>
		</Page>
		</Document >
